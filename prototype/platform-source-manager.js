(function () {
  const sources = [
    ...
    { name: "Ford Espana", group: "Programa RSC", territory: "Espana", url: "https://www.fromtheroad.ford.com/es/es/articles/2025/la-iniciativa-ford-construyendo-juntos-arranca-con-una-campana-h", sourceStatus: "Fuente oficial", connectorStatus: "Solo vigilancia", cadence: "Mensual", normalization: "No es convocatoria", basis: "Sin bases ni via de solicitud", output: "No crear oportunidad", depth: "Vigilar publicacion oficial de convocatoria y bases", doubt: "Ford describe un programa comunitario, no una convocatoria abierta.", action: "Activar solo si Ford publica bases, plazo y canal de solicitud." }
  ];
