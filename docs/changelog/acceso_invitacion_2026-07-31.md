...
La portada reconoce enlaces de invitacion de Supabase y permite establecer una contrasena una sola vez, sin guardar tokens ni contrasenas en el navegador.
